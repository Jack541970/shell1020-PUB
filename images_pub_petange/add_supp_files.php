...
<article class="wrapper">
            <div class="button-container">
              <button><a href="../images_pub_rodange/add_supp_files.php">RODANGE</a></button>
              <button style="background-color: #3fed1c;">PETANGE</a></button>
              <button><a href="../images_pub_differdange/add_supp_files.php">DIFFERDANGE</a></button>
              <button><a href="../images_pub_neudorf/add_supp_files.php">NEUDORF</a></button>
              <button><a href="../images_pub_martelange/add_supp_files.php">MARTELANGE</a></button>
              <button><a href="../images_pub_wamperhaart/add_supp_files.php">WÄMPERHAART</a></button>
            </div>
</div>
...
<form action="manage_files.php" method="post">
    ...
    <input type="submit" name="delete" value="Supprimer les fichiers sélectionnés" style="color: red;">
...
<div class="">
    ...
    $queryPub2 = "SELECT nom, contenu FROM pub4";
