    ...
    if (isset($_POST["filesToManage"])) {
        ...
        if (isset($_POST["delete"])) {
            foreach ($selectedFiles as $fileId) {
                ...
                $queryDelete = "DELETE FROM pub3 WHERE id = ?";
        ...
        if (isset($_POST["copy"])) {
            foreach ($selectedFiles as $fileId) {
                ...
                $querySelect = "SELECT nom, contenu FROM pub3 WHERE id = ?";
