    ...
    if (isset($_POST["filesToManage"])) {
        ...
        if (isset($_POST["delete"])) {
            foreach ($selectedFiles as $fileId) {
                ...
                $queryDelete = "DELETE FROM pub9 WHERE id = ?";
        ...
        if (isset($_POST["copy"])) {
            foreach ($selectedFiles as $fileId) {
                ...
                $querySelect = "SELECT nom, contenu FROM pub9 WHERE id = ?";
