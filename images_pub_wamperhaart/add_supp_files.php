...
<article class="wrapper">
          ...
          <button><a href="../images_pub_rodange/add_supp_files.php">RODANGE</a></button>
              <button><a href="../images_pub_petange/add_supp_files.php">PETANGE</a></button>
              ...
              <button style="background-color: #3fed1c;">WÄMPERHAART</a></button>
...
<form action="manage_files.php" method="post">
    <ul>
        ...
        $query = "SELECT id, nom FROM pub11";
        $stmt = $db->query($query);
...
<div class="">
    ...
    $queryPub2 = "SELECT nom, contenu FROM pub12";
